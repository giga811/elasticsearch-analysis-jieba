...
**5.6.10**
```sh
./bin/plugin install https://github.com/giga811/elasticsearch-analysis-jieba/releases/download/v5.6.10/elasticsearch-analysis-jieba-5.6.10-bin.zip
```

**5.6.14**
```sh
./bin/plugin install https://github.com/giga811/elasticsearch-analysis-jieba/releases/download/v5.6.14/elasticsearch-analysis-jieba-5.6.14-bin.zip
```
...
github-release upload \
    ...
    --repo elasticsearch-analysis-jieba \
    --tag v5.6.14 \
    --name elasticsearch-analysis-jieba-5.6.14-bin.zip \
    --file target/releases/elasticsearch-analysis-jieba-5.6.14-bin.zip

github-release upload \
    --user kaorimatz \
    --repo elasticsearch-analysis-jieba \
    --tag v5.6.14 \
    --name elasticsearch-analysis-jieba-5.6.14-bin.zip.sha1 \
    --file target/releases/elasticsearch-analysis-jieba-5.6.14-bin.zip.sha1
```
